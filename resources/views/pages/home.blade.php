                                    ...
                                    <div class="slider__item">
                                        <div class="anime">
                                            <a title="{{ $release->title }}" href="{{ route('anime.default', ['anime_slug' => $release->slug_name]) }}">
                                                <div class="poster">
                                                    <img height="225px" data-src="{{ ZAnimesControl::url('animes/' . $release->slug_name . '/' . $release->image) }}" data-srcset="{{ ZAnimesControl::url('animes/' . $release->slug_name . '/' . $release->image) }}" data-sizes="(max-width: 125px) 100vw, 125px" class="img-responsive lazyload" src="{{ asset('images/video_empty.png') }}" style="padding-top:180px; " alt="{{ $release->name }}"/>
                                                </div>
                                                <div class="info">
                        ...
                        <div class="slider__item">
                            <div class="anime">
                                <a title="{{ $weekly->title }}" href="{{ route('anime.default', ['anime_slug' => $weekly->slug_name]) }}">
                                    <div class="poster">
                                        <img data-src="{{ ZAnimesControl::url('animes/' . $weekly->slug_name . '/' . $weekly->image) }}" data-srcset="{{ ZAnimesControl::url('animes/' . $weekly->slug_name . '/' . $weekly->image) }}" data-sizes="(max-width: 125px) 100vw, 125px" class="img-responsive lazyload" src="{{ asset('images/video_empty.png') }}" style="padding-top:180px; " alt="{{ $weekly->name }}"/>
                                    </div>
                                    <div class="info">
