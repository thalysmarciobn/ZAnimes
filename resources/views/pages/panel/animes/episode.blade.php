                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="anime">
                                        <div class="poster">
                                            <img data-src="{{ ZAnimesControl::url('animes/' . $episode->poster) }}" data-srcset="{{ ZAnimesControl::url('animes/' . $episode->poster) }}" data-sizes="(max-width: 125px) 100vw, 125px" class="img-responsive effect-fade lazyloaded" src="{{ ZAnimesControl::url('animes/' . $episode->poster) }}" style="padding-top:180px; " sizes="(max-width: 125px) 100vw, 125px" srcset="{{ ZAnimesControl::url('animes/' . $episode->poster) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
