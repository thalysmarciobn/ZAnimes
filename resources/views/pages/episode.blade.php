                                                ...
                                                <div class="data">
                                                    <div class="thumb c-image-hover">
                                                        <a href="{{ route('anime.episode', ['anime_slug' => $_episode->season->anime->slug_name, 'episode' => $_episode->episode, 'episode_slug' => $_episode->slug, 'season' => $_episode->season_id]) }}">
                                                            <img data-src="{{ ZAnimesControl::url('animes/' . $_episode->image) }}" data-srcset="{{ ZAnimesControl::url('animes/' . $_episode->image) }}"  class="img-responsive lazyload effect-fade" alt="{{ $_episode->name }}"/>
